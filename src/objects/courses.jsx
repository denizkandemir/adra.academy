...
const courses = [
...

    {
      ...
      id: 4,
      path: "/yabancıDilKoçluğu",
      text: "Academy Adra olarak, dil öğrenme sürecinizi daha verimli ve etkili hale getirmek için sunduğumuz yabancı dil koçluğu hizmetleriyle, kişiye özel çözümler sunuyoruz. Yabancı dil koçluğu, sadece dil bilgisini öğrenmekle kalmayıp, aynı zamanda dilde akıcılığı kazanma ve günlük hayatta aktif kullanma becerilerini geliştirmek isteyenler için ideal bir destek sürecidir.",  
